...
//
// On Mon May  8 22:23:32 IST 2023
//
//
// Ports:
// Name                         I/O  size props
...
module mkCoalesce2(CLK,
  ...
  // register _unnamed_
  reg [511 : 0] _unnamed_;
  wire [511 : 0] _unnamed_$D_IN;
  wire _unnamed_$EN;

  // register _unnamed__1
  reg [511 : 0] _unnamed__1;
  wire [511 : 0] _unnamed__1$D_IN;
  wire _unnamed__1$EN;

  // register _unnamed__2
  reg [511 : 0] _unnamed__2;
  wire [511 : 0] _unnamed__2$D_IN;
  wire _unnamed__2$EN;

  // register _unnamed__3
  reg [511 : 0] _unnamed__3;
  wire [511 : 0] _unnamed__3$D_IN;
  wire _unnamed__3$EN;
  ...
  wire [511 : 0] MUX__unnamed__1$write_1__VAL_1,
  ...
  // submodule inQ
  FIFO2 #(.width(32'd512), .guarded(1'd1)) inQ(.RST(RST_N),
					       .CLK(CLK),
					       .D_IN(inQ$D_IN),
					       .ENQ(inQ$ENQ),
					       .DEQ(inQ$DEQ),
  ...
  assign MUX__unnamed__1$write_1__VAL_2 = _unnamed__1 << x__h3913 ;
  ...
  // register _unnamed__2
  assign _unnamed__2$D_IN = 512'h0 ;
  assign _unnamed__2$EN = 1'b0 ;

  // register _unnamed__3
  assign _unnamed__3$D_IN = 512'h0 ;
  ...
  // remaining internal signals
  assign x__h3913 = { shift_amount[6:0], 3'd0 } ;
  ...
  begin
    if (RST_N == `BSV_RESET_VALUE)
      begin
        _unnamed_ <= `BSV_ASSIGNMENT_DELAY 512'd0;
	_unnamed__1 <= `BSV_ASSIGNMENT_DELAY 512'd0;
	_unnamed__2 <= `BSV_ASSIGNMENT_DELAY 512'd0;
	_unnamed__3 <= `BSV_ASSIGNMENT_DELAY 512'd0;
