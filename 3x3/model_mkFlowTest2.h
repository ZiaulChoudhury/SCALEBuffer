...
/* Generation options: */
#ifndef __model_mkFlowTest2_h__
#define __model_mkFlowTest2_h__
...
/* Class declaration for a model of mkFlowTest2 */
class MODEL_mkFlowTest2 : public Model {
 
 /* Top-level module instance */
 private:
  MOD_mkFlowTest2 *mkFlowTest2_instance;
...
#endif /* ifndef __model_mkFlowTest2_h__ */
