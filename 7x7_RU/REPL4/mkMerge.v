...
//
// On Mon Jan 24 16:34:11 GMT 2022
//
//
// Ports:
// Name                         I/O  size props
...
module mkMerge(CLK,
  ...
  reg [79 : 0] _unnamed__80;
  wire [79 : 0] _unnamed__80$D_IN;
  ...
  wire [79 : 0] IF_mem_wDataOut_whas__68_THEN_mem_wDataOut_wge_ETC___d279,
		d1__h19898,
		x3__h11898,
		x_wget__h11680;
  wire [47 : 0] x2__h14109,
		x2__h15136,
		x2__h15634,
		x2__h16132,
		x2__h16630,
  ...
  wire [23 : 0] x2__h12990,
		...
		x__h17898,
		x__h18396;
  wire [12 : 0] x__h11981, x__h12070;
  wire NOT_mem_rRdPtr_read__7_EQ_mem_rWrPtr_read_65_6_ETC___d274,
       NOT_mem_rRdPtr_read__7_PLUS_2048_16_EQ_mem_rWr_ETC___d218,
       cx2_26_ULT_width_27___d228;
  ...
  // inputs to muxes for submodule ports
  assign MUX_mem_wDataIn$wset_1__VAL_2 = { 32'd0, _unnamed__80[79:32] } ;

  // inlined wires
  assign mem_pwDequeue$whas =
	     NOT_mem_rRdPtr_read__7_EQ_mem_rWrPtr_read_65_6_ETC___d274 &&
	     !cx2_26_ULT_width_27___d228 ;
  ...
  assign _unnamed_$D_IN =
	     IF_mem_wDataOut_whas__68_THEN_mem_wDataOut_wge_ETC___d279[7:0] ;
  ...
  // register _unnamed__0_2
  assign _unnamed__0_2$D_IN = x__h13306 | x2__h12990 ;
  assign _unnamed__0_2$EN = 1'd1 ;

  // register _unnamed__0_3
  assign _unnamed__0_3$D_IN = x__h13679 | x2__h13363 ;
  assign _unnamed__0_3$EN = 1'd1 ;

  // register _unnamed__0_4
  assign _unnamed__0_4$D_IN = x__h14052 | x2__h13736 ;
  assign _unnamed__0_4$EN = 1'd1 ;

  // register _unnamed__0_5
  assign _unnamed__0_5$D_IN = x__h14425 | x2__h14109 ;
  ...
  assign _unnamed__1$D_IN =
	     IF_mem_wDataOut_whas__68_THEN_mem_wDataOut_wge_ETC___d279[15:8] ;
  assign _unnamed__1$EN = mem_pwDequeue$whas ;

  // register _unnamed__10
  assign _unnamed__10$D_IN = { _unnamed__10[47:0], _unnamed__0_6[7:0] } ;
  assign _unnamed__10$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__11
  assign _unnamed__11$D_IN = { _unnamed__11[47:0], _unnamed__0_6[15:8] } ;
  assign _unnamed__11$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__12
  assign _unnamed__12$D_IN = { _unnamed__12[47:0], _unnamed__0_6[23:16] } ;
  assign _unnamed__12$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__13
  assign _unnamed__13$D_IN = { _unnamed__13[47:0], _unnamed__0_6[31:24] } ;
  assign _unnamed__13$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__14
  assign _unnamed__14$D_IN = { _unnamed__14[47:0], _unnamed__0_6[39:32] } ;
  assign _unnamed__14$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__15
  assign _unnamed__15$D_IN = { _unnamed__15[47:0], _unnamed__0_6[47:40] } ;
  assign _unnamed__15$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__16
  assign _unnamed__16$D_IN = { _unnamed__16[47:0], _unnamed__0_6[55:48] } ;
  assign _unnamed__16$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__17
  assign _unnamed__17$D_IN = { _unnamed__17[47:0], _unnamed__1_6[7:0] } ;
  assign _unnamed__17$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__18
  assign _unnamed__18$D_IN = { _unnamed__18[47:0], _unnamed__1_6[15:8] } ;
  assign _unnamed__18$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__19
  assign _unnamed__19$D_IN = { _unnamed__19[47:0], _unnamed__1_6[23:16] } ;
  ...
  // register _unnamed__1_2
  assign _unnamed__1_2$D_IN = x__h14910 | x2__h14881 ;
  assign _unnamed__1_2$EN = 1'd1 ;

  // register _unnamed__1_3
  assign _unnamed__1_3$D_IN = x__h14995 | x2__h14966 ;
  assign _unnamed__1_3$EN = 1'd1 ;

  // register _unnamed__1_4
  assign _unnamed__1_4$D_IN = x__h15080 | x2__h15051 ;
  assign _unnamed__1_4$EN = 1'd1 ;

  // register _unnamed__1_5
  assign _unnamed__1_5$D_IN = x__h15166 | x2__h15136 ;
  ...
  assign _unnamed__2$D_IN =
	     IF_mem_wDataOut_whas__68_THEN_mem_wDataOut_wge_ETC___d279[23:16] ;
  assign _unnamed__2$EN = mem_pwDequeue$whas ;

  // register _unnamed__20
  assign _unnamed__20$D_IN = { _unnamed__20[47:0], _unnamed__1_6[31:24] } ;
  assign _unnamed__20$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__21
  assign _unnamed__21$D_IN = { _unnamed__21[47:0], _unnamed__1_6[39:32] } ;
  assign _unnamed__21$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__22
  assign _unnamed__22$D_IN = { _unnamed__22[47:0], _unnamed__1_6[47:40] } ;
  assign _unnamed__22$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__23
  assign _unnamed__23$D_IN = { _unnamed__23[47:0], _unnamed__1_6[55:48] } ;
  assign _unnamed__23$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__24
  assign _unnamed__24$D_IN = { _unnamed__24[47:0], _unnamed__2_6[7:0] } ;
  assign _unnamed__24$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__25
  assign _unnamed__25$D_IN = { _unnamed__25[47:0], _unnamed__2_6[15:8] } ;
  assign _unnamed__25$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__26
  assign _unnamed__26$D_IN = { _unnamed__26[47:0], _unnamed__2_6[23:16] } ;
  assign _unnamed__26$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__27
  assign _unnamed__27$D_IN = { _unnamed__27[47:0], _unnamed__2_6[31:24] } ;
  assign _unnamed__27$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__28
  assign _unnamed__28$D_IN = { _unnamed__28[47:0], _unnamed__2_6[39:32] } ;
  assign _unnamed__28$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__29
  assign _unnamed__29$D_IN = { _unnamed__29[47:0], _unnamed__2_6[47:40] } ;
  ...
  // register _unnamed__2_2
  assign _unnamed__2_2$D_IN = x__h15408 | x2__h15379 ;
  assign _unnamed__2_2$EN = 1'd1 ;

  // register _unnamed__2_3
  assign _unnamed__2_3$D_IN = x__h15493 | x2__h15464 ;
  assign _unnamed__2_3$EN = 1'd1 ;

  // register _unnamed__2_4
  assign _unnamed__2_4$D_IN = x__h15578 | x2__h15549 ;
  assign _unnamed__2_4$EN = 1'd1 ;

  // register _unnamed__2_5
  assign _unnamed__2_5$D_IN = x__h15664 | x2__h15634 ;
  ...
  assign _unnamed__3$D_IN =
	     IF_mem_wDataOut_whas__68_THEN_mem_wDataOut_wge_ETC___d279[31:24] ;
  assign _unnamed__3$EN = mem_pwDequeue$whas ;

  // register _unnamed__30
  assign _unnamed__30$D_IN = { _unnamed__30[47:0], _unnamed__2_6[55:48] } ;
  assign _unnamed__30$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__31
  assign _unnamed__31$D_IN = { _unnamed__31[47:0], _unnamed__3_6[7:0] } ;
  assign _unnamed__31$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__32
  assign _unnamed__32$D_IN = { _unnamed__32[47:0], _unnamed__3_6[15:8] } ;
  assign _unnamed__32$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__33
  assign _unnamed__33$D_IN = { _unnamed__33[47:0], _unnamed__3_6[23:16] } ;
  assign _unnamed__33$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__34
  assign _unnamed__34$D_IN = { _unnamed__34[47:0], _unnamed__3_6[31:24] } ;
  assign _unnamed__34$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__35
  assign _unnamed__35$D_IN = { _unnamed__35[47:0], _unnamed__3_6[39:32] } ;
  assign _unnamed__35$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__36
  assign _unnamed__36$D_IN = { _unnamed__36[47:0], _unnamed__3_6[47:40] } ;
  assign _unnamed__36$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__37
  assign _unnamed__37$D_IN = { _unnamed__37[47:0], _unnamed__3_6[55:48] } ;
  assign _unnamed__37$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__38
  assign _unnamed__38$D_IN = { _unnamed__38[47:0], _unnamed__4_6[7:0] } ;
  assign _unnamed__38$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__39
  assign _unnamed__39$D_IN = { _unnamed__39[47:0], _unnamed__4_6[15:8] } ;
  ...
  // register _unnamed__3_2
  assign _unnamed__3_2$D_IN = x__h15906 | x2__h15877 ;
  assign _unnamed__3_2$EN = 1'd1 ;

  // register _unnamed__3_3
  assign _unnamed__3_3$D_IN = x__h15991 | x2__h15962 ;
  assign _unnamed__3_3$EN = 1'd1 ;

  // register _unnamed__3_4
  assign _unnamed__3_4$D_IN = x__h16076 | x2__h16047 ;
  assign _unnamed__3_4$EN = 1'd1 ;

  // register _unnamed__3_5
  assign _unnamed__3_5$D_IN = x__h16162 | x2__h16132 ;
  ...
  assign _unnamed__4$D_IN =
	     IF_mem_wDataOut_whas__68_THEN_mem_wDataOut_wge_ETC___d279[39:32] ;
  assign _unnamed__4$EN = mem_pwDequeue$whas ;

  // register _unnamed__40
  assign _unnamed__40$D_IN = { _unnamed__40[47:0], _unnamed__4_6[23:16] } ;
  assign _unnamed__40$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__41
  assign _unnamed__41$D_IN = { _unnamed__41[47:0], _unnamed__4_6[31:24] } ;
  assign _unnamed__41$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__42
  assign _unnamed__42$D_IN = { _unnamed__42[47:0], _unnamed__4_6[39:32] } ;
  assign _unnamed__42$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__43
  assign _unnamed__43$D_IN = { _unnamed__43[47:0], _unnamed__4_6[47:40] } ;
  assign _unnamed__43$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__44
  assign _unnamed__44$D_IN = { _unnamed__44[47:0], _unnamed__4_6[55:48] } ;
  assign _unnamed__44$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__45
  assign _unnamed__45$D_IN = { _unnamed__45[47:0], _unnamed__5_6[7:0] } ;
  assign _unnamed__45$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__46
  assign _unnamed__46$D_IN = { _unnamed__46[47:0], _unnamed__5_6[15:8] } ;
  assign _unnamed__46$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__47
  assign _unnamed__47$D_IN = { _unnamed__47[47:0], _unnamed__5_6[23:16] } ;
  assign _unnamed__47$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__48
  assign _unnamed__48$D_IN = { _unnamed__48[47:0], _unnamed__5_6[31:24] } ;
  assign _unnamed__48$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__49
  assign _unnamed__49$D_IN = { _unnamed__49[47:0], _unnamed__5_6[39:32] } ;
  ...
  // register _unnamed__4_2
  assign _unnamed__4_2$D_IN = x__h16404 | x2__h16375 ;
  assign _unnamed__4_2$EN = 1'd1 ;

  // register _unnamed__4_3
  assign _unnamed__4_3$D_IN = x__h16489 | x2__h16460 ;
  assign _unnamed__4_3$EN = 1'd1 ;

  // register _unnamed__4_4
  assign _unnamed__4_4$D_IN = x__h16574 | x2__h16545 ;
  assign _unnamed__4_4$EN = 1'd1 ;

  // register _unnamed__4_5
  assign _unnamed__4_5$D_IN = x__h16660 | x2__h16630 ;
  ...
  assign _unnamed__5$D_IN =
	     IF_mem_wDataOut_whas__68_THEN_mem_wDataOut_wge_ETC___d279[47:40] ;
  assign _unnamed__5$EN = mem_pwDequeue$whas ;

  // register _unnamed__50
  assign _unnamed__50$D_IN = { _unnamed__50[47:0], _unnamed__5_6[47:40] } ;
  assign _unnamed__50$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__51
  assign _unnamed__51$D_IN = { _unnamed__51[47:0], _unnamed__5_6[55:48] } ;
  assign _unnamed__51$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__52
  assign _unnamed__52$D_IN = { _unnamed__52[47:0], _unnamed__6_6[7:0] } ;
  assign _unnamed__52$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__53
  assign _unnamed__53$D_IN = { _unnamed__53[47:0], _unnamed__6_6[15:8] } ;
  assign _unnamed__53$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__54
  assign _unnamed__54$D_IN = { _unnamed__54[47:0], _unnamed__6_6[23:16] } ;
  assign _unnamed__54$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__55
  assign _unnamed__55$D_IN = { _unnamed__55[47:0], _unnamed__6_6[31:24] } ;
  assign _unnamed__55$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__56
  assign _unnamed__56$D_IN = { _unnamed__56[47:0], _unnamed__6_6[39:32] } ;
  assign _unnamed__56$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__57
  assign _unnamed__57$D_IN = { _unnamed__57[47:0], _unnamed__6_6[47:40] } ;
  assign _unnamed__57$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__58
  assign _unnamed__58$D_IN = { _unnamed__58[47:0], _unnamed__6_6[55:48] } ;
  assign _unnamed__58$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__59
  assign _unnamed__59$D_IN = { _unnamed__59[47:0], _unnamed__7_6[7:0] } ;
  ...
  // register _unnamed__5_2
  assign _unnamed__5_2$D_IN = x__h16902 | x2__h16873 ;
  assign _unnamed__5_2$EN = 1'd1 ;

  // register _unnamed__5_3
  assign _unnamed__5_3$D_IN = x__h16987 | x2__h16958 ;
  assign _unnamed__5_3$EN = 1'd1 ;

  // register _unnamed__5_4
  assign _unnamed__5_4$D_IN = x__h17072 | x2__h17043 ;
  assign _unnamed__5_4$EN = 1'd1 ;

  // register _unnamed__5_5
  assign _unnamed__5_5$D_IN = x__h17158 | x2__h17128 ;
  ...
  assign _unnamed__6$D_IN =
	     IF_mem_wDataOut_whas__68_THEN_mem_wDataOut_wge_ETC___d279[55:48] ;
  assign _unnamed__6$EN = mem_pwDequeue$whas ;

  // register _unnamed__60
  assign _unnamed__60$D_IN = { _unnamed__60[47:0], _unnamed__7_6[15:8] } ;
  assign _unnamed__60$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__61
  assign _unnamed__61$D_IN = { _unnamed__61[47:0], _unnamed__7_6[23:16] } ;
  assign _unnamed__61$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__62
  assign _unnamed__62$D_IN = { _unnamed__62[47:0], _unnamed__7_6[31:24] } ;
  assign _unnamed__62$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__63
  assign _unnamed__63$D_IN = { _unnamed__63[47:0], _unnamed__7_6[39:32] } ;
  assign _unnamed__63$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__64
  assign _unnamed__64$D_IN = { _unnamed__64[47:0], _unnamed__7_6[47:40] } ;
  assign _unnamed__64$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__65
  assign _unnamed__65$D_IN = { _unnamed__65[47:0], _unnamed__7_6[55:48] } ;
  assign _unnamed__65$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__66
  assign _unnamed__66$D_IN = { _unnamed__66[47:0], _unnamed__8_6[7:0] } ;
  assign _unnamed__66$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__67
  assign _unnamed__67$D_IN = { _unnamed__67[47:0], _unnamed__8_6[15:8] } ;
  assign _unnamed__67$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__68
  assign _unnamed__68$D_IN = { _unnamed__68[47:0], _unnamed__8_6[23:16] } ;
  assign _unnamed__68$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__69
  assign _unnamed__69$D_IN = { _unnamed__69[47:0], _unnamed__8_6[31:24] } ;
  ...
  // register _unnamed__6_2
  assign _unnamed__6_2$D_IN = x__h17400 | x2__h17371 ;
  assign _unnamed__6_2$EN = 1'd1 ;

  // register _unnamed__6_3
  assign _unnamed__6_3$D_IN = x__h17485 | x2__h17456 ;
  assign _unnamed__6_3$EN = 1'd1 ;

  // register _unnamed__6_4
  assign _unnamed__6_4$D_IN = x__h17570 | x2__h17541 ;
  assign _unnamed__6_4$EN = 1'd1 ;

  // register _unnamed__6_5
  assign _unnamed__6_5$D_IN = x__h17656 | x2__h17626 ;
  ...
  assign _unnamed__7$D_IN =
	     IF_mem_wDataOut_whas__68_THEN_mem_wDataOut_wge_ETC___d279[63:56] ;
  assign _unnamed__7$EN = mem_pwDequeue$whas ;

  // register _unnamed__70
  assign _unnamed__70$D_IN = { _unnamed__70[47:0], _unnamed__8_6[39:32] } ;
  assign _unnamed__70$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__71
  assign _unnamed__71$D_IN = { _unnamed__71[47:0], _unnamed__8_6[47:40] } ;
  assign _unnamed__71$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__72
  assign _unnamed__72$D_IN = { _unnamed__72[47:0], _unnamed__8_6[55:48] } ;
  assign _unnamed__72$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__73
  assign _unnamed__73$D_IN = { _unnamed__73[47:0], _unnamed__9_6[7:0] } ;
  assign _unnamed__73$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__74
  assign _unnamed__74$D_IN = { _unnamed__74[47:0], _unnamed__9_6[15:8] } ;
  assign _unnamed__74$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__75
  assign _unnamed__75$D_IN = { _unnamed__75[47:0], _unnamed__9_6[23:16] } ;
  assign _unnamed__75$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__76
  assign _unnamed__76$D_IN = { _unnamed__76[47:0], _unnamed__9_6[31:24] } ;
  assign _unnamed__76$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__77
  assign _unnamed__77$D_IN = { _unnamed__77[47:0], _unnamed__9_6[39:32] } ;
  assign _unnamed__77$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__78
  assign _unnamed__78$D_IN = { _unnamed__78[47:0], _unnamed__9_6[47:40] } ;
  assign _unnamed__78$EN = p6_rv[1] && !p7_rv$port1__read[1] ;

  // register _unnamed__79
  assign _unnamed__79$D_IN = { _unnamed__79[47:0], _unnamed__9_6[55:48] } ;
  ...
  // register _unnamed__7_2
  assign _unnamed__7_2$D_IN = x__h17898 | x2__h17869 ;
  assign _unnamed__7_2$EN = 1'd1 ;

  // register _unnamed__7_3
  assign _unnamed__7_3$D_IN = x__h17983 | x2__h17954 ;
  assign _unnamed__7_3$EN = 1'd1 ;

  // register _unnamed__7_4
  assign _unnamed__7_4$D_IN = x__h18068 | x2__h18039 ;
  assign _unnamed__7_4$EN = 1'd1 ;

  // register _unnamed__7_5
  assign _unnamed__7_5$D_IN = x__h18154 | x2__h18124 ;
  ...
  assign _unnamed__8$D_IN =
	     IF_mem_wDataOut_whas__68_THEN_mem_wDataOut_wge_ETC___d279[71:64] ;
  assign _unnamed__8$EN = mem_pwDequeue$whas ;

  // register _unnamed__80
  assign _unnamed__80$D_IN = 80'h0 ;
  assign _unnamed__80$EN = 1'b0 ;
  ...
  // register _unnamed__8_2
  assign _unnamed__8_2$D_IN = x__h18396 | x2__h18367 ;
  assign _unnamed__8_2$EN = 1'd1 ;

  // register _unnamed__8_3
  assign _unnamed__8_3$D_IN = x__h18481 | x2__h18452 ;
  assign _unnamed__8_3$EN = 1'd1 ;

  // register _unnamed__8_4
  assign _unnamed__8_4$D_IN = x__h18566 | x2__h18537 ;
  assign _unnamed__8_4$EN = 1'd1 ;

  // register _unnamed__8_5
  assign _unnamed__8_5$D_IN = x__h18652 | x2__h18622 ;
  ...
  assign _unnamed__9$D_IN =
	     IF_mem_wDataOut_whas__68_THEN_mem_wDataOut_wge_ETC___d279[79:72] ;
  ...
  // register _unnamed__9_3
  assign _unnamed__9_3$D_IN = 32'h0 ;
  assign _unnamed__9_3$EN = 1'b0 ;

  // register _unnamed__9_4
  assign _unnamed__9_4$D_IN = 40'h0 ;
  assign _unnamed__9_4$EN = 1'b0 ;

  // register _unnamed__9_5
  assign _unnamed__9_5$D_IN = 48'h0 ;
  assign _unnamed__9_5$EN = 1'b0 ;

  // register _unnamed__9_6
  assign _unnamed__9_6$D_IN = 56'h0 ;
  ...
  // register mem_rCache
  assign mem_rCache$D_IN = { 1'd1, mem_rWrPtr, x3__h11898 } ;
  assign mem_rCache$EN = mem_pwEnqueue$whas ;

  // register mem_rRdPtr
  assign mem_rRdPtr$D_IN = x__h12070 ;
  assign mem_rRdPtr$EN = mem_pwDequeue$whas ;

  // register mem_rWrPtr
  assign mem_rWrPtr$D_IN = x__h11981 ;
  ...
  assign mem_memory$ADDRB =
	     mem_pwDequeue$whas ? x__h12070[11:0] : mem_rRdPtr[11:0] ;
  assign mem_memory$DIA = x3__h11898 ;
  ...
  // remaining internal signals
  assign IF_mem_wDataOut_whas__68_THEN_mem_wDataOut_wge_ETC___d279 =
	     d1__h19898 | inQ$D_OUT ;
  assign NOT_mem_rRdPtr_read__7_EQ_mem_rWrPtr_read_65_6_ETC___d274 =
	     mem_rRdPtr != mem_rWrPtr && inQ$EMPTY_N &&
	     !p0_rv$port1__read[1] ;
  assign NOT_mem_rRdPtr_read__7_PLUS_2048_16_EQ_mem_rWr_ETC___d218 =
	     mem_rRdPtr + 13'd2048 != mem_rWrPtr ;
  assign cx2_26_ULT_width_27___d228 = cx2 < width ;
  assign d1__h19898 =
	     (mem_rCache[93] && mem_rCache[92:80] == mem_rRdPtr) ?
	       mem_rCache[79:0] :
	       mem_memory$DOB ;
  assign x2__h12990 = { 8'd0, _unnamed__1_1 } ;
  assign x2__h13363 = { 8'd0, _unnamed__1_2 } ;
  assign x2__h13736 = { 8'd0, _unnamed__1_3 } ;
  assign x2__h14109 = { 8'd0, _unnamed__1_4 } ;
  assign x2__h14881 = { 8'd0, _unnamed__2_1 } ;
  assign x2__h14966 = { 8'd0, _unnamed__2_2 } ;
  assign x2__h15051 = { 8'd0, _unnamed__2_3 } ;
  assign x2__h15136 = { 8'd0, _unnamed__2_4 } ;
  assign x2__h15379 = { 8'd0, _unnamed__3_1 } ;
  assign x2__h15464 = { 8'd0, _unnamed__3_2 } ;
  assign x2__h15549 = { 8'd0, _unnamed__3_3 } ;
  assign x2__h15634 = { 8'd0, _unnamed__3_4 } ;
  assign x2__h15877 = { 8'd0, _unnamed__4_1 } ;
  assign x2__h15962 = { 8'd0, _unnamed__4_2 } ;
  assign x2__h16047 = { 8'd0, _unnamed__4_3 } ;
  assign x2__h16132 = { 8'd0, _unnamed__4_4 } ;
  assign x2__h16375 = { 8'd0, _unnamed__5_1 } ;
  assign x2__h16460 = { 8'd0, _unnamed__5_2 } ;
  assign x2__h16545 = { 8'd0, _unnamed__5_3 } ;
  assign x2__h16630 = { 8'd0, _unnamed__5_4 } ;
  assign x2__h16873 = { 8'd0, _unnamed__6_1 } ;
  assign x2__h16958 = { 8'd0, _unnamed__6_2 } ;
  assign x2__h17043 = { 8'd0, _unnamed__6_3 } ;
  assign x2__h17128 = { 8'd0, _unnamed__6_4 } ;
  assign x2__h17371 = { 8'd0, _unnamed__7_1 } ;
  assign x2__h17456 = { 8'd0, _unnamed__7_2 } ;
  assign x2__h17541 = { 8'd0, _unnamed__7_3 } ;
  assign x2__h17626 = { 8'd0, _unnamed__7_4 } ;
  assign x2__h17869 = { 8'd0, _unnamed__8_1 } ;
  assign x2__h17954 = { 8'd0, _unnamed__8_2 } ;
  assign x2__h18039 = { 8'd0, _unnamed__8_3 } ;
  assign x2__h18124 = { 8'd0, _unnamed__8_4 } ;
  assign x2__h18367 = { 8'd0, _unnamed__9_1 } ;
  assign x2__h18452 = { 8'd0, _unnamed__9_2 } ;
  assign x2__h18537 = { 8'd0, _unnamed__9_3 } ;
  assign x2__h18622 = { 8'd0, _unnamed__9_4 } ;
  assign x3__h11898 = mem_pwEnqueue$whas ? x_wget__h11680 : 80'd0 ;
  assign x__h11981 = mem_rWrPtr + 13'd1 ;
  assign x__h12070 = mem_rRdPtr + 13'd1 ;
  assign x__h13306 = { _unnamed__0_1, 8'd0 } ;
  assign x__h13679 = { _unnamed__0_2, 8'd0 } ;
  assign x__h14052 = { _unnamed__0_3, 8'd0 } ;
  assign x__h14425 = { _unnamed__0_4, 8'd0 } ;
  assign x__h14910 = { _unnamed__1_1, 8'd0 } ;
  assign x__h14995 = { _unnamed__1_2, 8'd0 } ;
  assign x__h15080 = { _unnamed__1_3, 8'd0 } ;
  assign x__h15166 = { _unnamed__1_4, 8'd0 } ;
  assign x__h15408 = { _unnamed__2_1, 8'd0 } ;
  assign x__h15493 = { _unnamed__2_2, 8'd0 } ;
  assign x__h15578 = { _unnamed__2_3, 8'd0 } ;
  assign x__h15664 = { _unnamed__2_4, 8'd0 } ;
  assign x__h15906 = { _unnamed__3_1, 8'd0 } ;
  assign x__h15991 = { _unnamed__3_2, 8'd0 } ;
  assign x__h16076 = { _unnamed__3_3, 8'd0 } ;
  assign x__h16162 = { _unnamed__3_4, 8'd0 } ;
  assign x__h16404 = { _unnamed__4_1, 8'd0 } ;
  assign x__h16489 = { _unnamed__4_2, 8'd0 } ;
  assign x__h16574 = { _unnamed__4_3, 8'd0 } ;
  assign x__h16660 = { _unnamed__4_4, 8'd0 } ;
  assign x__h16902 = { _unnamed__5_1, 8'd0 } ;
  assign x__h16987 = { _unnamed__5_2, 8'd0 } ;
  assign x__h17072 = { _unnamed__5_3, 8'd0 } ;
  assign x__h17158 = { _unnamed__5_4, 8'd0 } ;
  assign x__h17400 = { _unnamed__6_1, 8'd0 } ;
  assign x__h17485 = { _unnamed__6_2, 8'd0 } ;
  assign x__h17570 = { _unnamed__6_3, 8'd0 } ;
  assign x__h17656 = { _unnamed__6_4, 8'd0 } ;
  assign x__h17898 = { _unnamed__7_1, 8'd0 } ;
  assign x__h17983 = { _unnamed__7_2, 8'd0 } ;
  assign x__h18068 = { _unnamed__7_3, 8'd0 } ;
  assign x__h18154 = { _unnamed__7_4, 8'd0 } ;
  assign x__h18396 = { _unnamed__8_1, 8'd0 } ;
  assign x__h18481 = { _unnamed__8_2, 8'd0 } ;
  assign x__h18566 = { _unnamed__8_3, 8'd0 } ;
  assign x__h18652 = { _unnamed__8_4, 8'd0 } ;
  assign x_wget__h11680 =
	     WILL_FIRE_RL_initialLoad ?
	       inQ$D_OUT :
  ...
  begin
	...
	_unnamed__80 <= `BSV_ASSIGNMENT_DELAY 80'd0;
  ...
  begin
    ...
    _unnamed__8 = 8'hAA;
    _unnamed__80 = 80'hAAAAAAAAAAAAAAAAAAAA;
