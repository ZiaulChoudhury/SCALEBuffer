...
//
// On Mon Jan 24 16:34:12 GMT 2022
//
//
// Ports:
// Name                         I/O  size props
...
module mkFlowTest(CLK,
  ...
  wire [63 : 0] _9_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_value_ETC___d34;
  wire [47 : 0] _9_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_value_ETC___d27;
  wire [31 : 0] _9_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_value_ETC___d20;
  wire [15 : 0] _3_MUL_value___d28,
		_5_MUL_value___d21,
		_6_MUL_value___d17,
		_7_MUL_value___d14,
		_9_MUL_value___d6;
  ...
  // inputs to muxes for submodule ports
  assign MUX_fetch$write_1__SEL_1 = cx_3$RDY_result && outQ$FULL_N ;
  ...
  assign cx_3$EN_result = MUX_fetch$write_1__SEL_1 ;
  ...
  assign px$put_datas =
	     { _9_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_value_ETC___d34,
	       value + seed,
	       seed } ;
  ...
  // remaining internal signals
  assign _3_MUL_value___d28 = 8'd3 * value ;
  assign _5_MUL_value___d21 = 8'd5 * value ;
  assign _6_MUL_value___d17 = 8'd6 * value ;
  assign _7_MUL_value___d14 = 8'd7 * value ;
  assign _9_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_value_ETC___d20 =
	     { _9_MUL_value___d6[7:0] + seed,
	       { value[4:0], 3'd0 } + seed,
	       _7_MUL_value___d14[7:0] + seed,
	       _6_MUL_value___d17[7:0] + seed } ;
  assign _9_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_value_ETC___d27 =
	     { _9_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_value_ETC___d20,
	       _5_MUL_value___d21[7:0] + seed,
	       { value[5:0], 2'd0 } + seed } ;
  assign _9_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_value_ETC___d34 =
	     { _9_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_value_ETC___d27,
	       _3_MUL_value___d28[7:0] + seed,
	       { value[6:0], 1'd0 } + seed } ;
  assign _9_MUL_value___d6 = 8'd9 * value ;
  ...
  begin
    ...
    init = 1'h0;
    out =
	1568';
    seed = 8'hAA;
    value = 8'hAA;
  end
