...
//
// On Fri Jan 21 12:33:25 GMT 2022
//
//
// Ports:
// Name                         I/O  size props
...
module mkFlowTest(CLK,
  ...
  wire [159 : 0] _21_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_20_M_ETC___d76;
  wire [143 : 0] _21_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_20_M_ETC___d69;
  wire [111 : 0] _21_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_20_M_ETC___d55;
  wire [79 : 0] _21_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_20_M_ETC___d41;
  wire [47 : 0] _21_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_20_M_ETC___d27;
  wire [31 : 0] _21_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_20_M_ETC___d20;
  wire [15 : 0] _10_MUL_value___d45,
		_11_MUL_value___d42,
		_12_MUL_value___d38,
		_13_MUL_value___d35,
		_14_MUL_value___d31,
  ...
  assign px$put_datas =
	     { _21_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_20_M_ETC___d76,
	       value + seed,
	       seed } ;
  ...
  // remaining internal signals
  assign _10_MUL_value___d45 = 8'd10 * value ;
  assign _11_MUL_value___d42 = 8'd11 * value ;
  assign _12_MUL_value___d38 = 8'd12 * value ;
  assign _13_MUL_value___d35 = 8'd13 * value ;
  assign _14_MUL_value___d31 = 8'd14 * value ;
  assign _15_MUL_value___d28 = 8'd15 * value ;
  assign _17_MUL_value___d21 = 8'd17 * value ;
  assign _18_MUL_value___d17 = 8'd18 * value ;
  assign _19_MUL_value___d14 = 8'd19 * value ;
  assign _20_MUL_value___d10 = 8'd20 * value ;
  assign _21_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_20_M_ETC___d20 =
	     { _21_MUL_value___d6[7:0] + seed,
	       _20_MUL_value___d10[7:0] + seed,
	       _19_MUL_value___d14[7:0] + seed,
	       _18_MUL_value___d17[7:0] + seed } ;
  assign _21_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_20_M_ETC___d27 =
	     { _21_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_20_M_ETC___d20,
	       _17_MUL_value___d21[7:0] + seed,
	       { value[3:0], 4'd0 } + seed } ;
  assign _21_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_20_M_ETC___d41 =
	     { _21_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_20_M_ETC___d27,
	       _15_MUL_value___d28[7:0] + seed,
	       _14_MUL_value___d31[7:0] + seed,
	       _13_MUL_value___d35[7:0] + seed,
	       _12_MUL_value___d38[7:0] + seed } ;
  assign _21_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_20_M_ETC___d55 =
	     { _21_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_20_M_ETC___d41,
	       _11_MUL_value___d42[7:0] + seed,
	       _10_MUL_value___d45[7:0] + seed,
	       _9_MUL_value___d49[7:0] + seed,
	       { value[4:0], 3'd0 } + seed } ;
  assign _21_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_20_M_ETC___d69 =
	     { _21_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_20_M_ETC___d55,
	       _7_MUL_value___d56[7:0] + seed,
	       _6_MUL_value___d59[7:0] + seed,
	       _5_MUL_value___d63[7:0] + seed,
	       { value[5:0], 2'd0 } + seed } ;
  assign _21_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_20_M_ETC___d76 =
	     { _21_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_20_M_ETC___d69,
	       _3_MUL_value___d70[7:0] + seed,
	       { value[6:0], 1'd0 } + seed } ;
  assign _21_MUL_value___d6 = 8'd21 * value ;
  assign _3_MUL_value___d70 = 8'd3 * value ;
  assign _5_MUL_value___d63 = 8'd5 * value ;
  assign _6_MUL_value___d59 = 8'd6 * value ;
  assign _7_MUL_value___d56 = 8'd7 * value ;
  assign _9_MUL_value___d49 = 8'd9 * value ;
  ...
  begin
    ...
    init = 1'h0;
    out =
	6272';
    seed = 8'hAA;
    value = 8'hAA;
  end
