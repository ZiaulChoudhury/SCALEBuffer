...
//
// On Fri Jan 21 12:23:50 GMT 2022
//
//
// Ports:
// Name                         I/O  size props
...
module mkFlowTest(CLK,
  ...
  wire [39 : 0] _6_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_5_MUL_ETC___d23;
  wire [23 : 0] _6_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_5_MUL_ETC___d16;
  wire [15 : 0] _3_MUL_value___d17, _5_MUL_value___d10, _6_MUL_value___d6;
  ...
  assign px$put_datas =
	     { _6_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_5_MUL_ETC___d23,
	       value + seed,
	       seed } ;
  ...
  // remaining internal signals
  assign _3_MUL_value___d17 = 8'd3 * value ;
  assign _5_MUL_value___d10 = 8'd5 * value ;
  assign _6_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_5_MUL_ETC___d16 =
	     { _6_MUL_value___d6[7:0] + seed,
	       _5_MUL_value___d10[7:0] + seed,
	       { value[5:0], 2'd0 } + seed } ;
  assign _6_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_5_MUL_ETC___d23 =
	     { _6_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_5_MUL_ETC___d16,
	       _3_MUL_value___d17[7:0] + seed,
	       { value[6:0], 1'd0 } + seed } ;
  assign _6_MUL_value___d6 = 8'd6 * value ;
