...
//
// On Fri Jan 21 16:00:44 GMT 2022
//
//
// Ports:
// Name                         I/O  size props
...
module mkFlowTest(CLK,
  ...
  wire [79 : 0] _11_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_10_M_ETC___d41;
  wire [63 : 0] _11_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_10_M_ETC___d34;
  wire [31 : 0] _11_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_10_M_ETC___d20;
  wire [15 : 0] _10_MUL_value___d10,
		_11_MUL_value___d6,
		_3_MUL_value___d35,
		_5_MUL_value___d28,
		_6_MUL_value___d24,
  ...
  assign px$put_datas =
	     { _11_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_10_M_ETC___d41,
	       value + seed,
	       seed } ;
  ...
  // remaining internal signals
  assign _10_MUL_value___d10 = 8'd10 * value ;
  assign _11_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_10_M_ETC___d20 =
	     { _11_MUL_value___d6[7:0] + seed,
	       _10_MUL_value___d10[7:0] + seed,
	       _9_MUL_value___d14[7:0] + seed,
	       { value[4:0], 3'd0 } + seed } ;
  assign _11_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_10_M_ETC___d34 =
	     { _11_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_10_M_ETC___d20,
	       _7_MUL_value___d21[7:0] + seed,
	       _6_MUL_value___d24[7:0] + seed,
	       _5_MUL_value___d28[7:0] + seed,
	       { value[5:0], 2'd0 } + seed } ;
  assign _11_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_10_M_ETC___d41 =
	     { _11_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_10_M_ETC___d34,
	       _3_MUL_value___d35[7:0] + seed,
	       { value[6:0], 1'd0 } + seed } ;
  assign _11_MUL_value___d6 = 8'd11 * value ;
  assign _3_MUL_value___d35 = 8'd3 * value ;
  assign _5_MUL_value___d28 = 8'd5 * value ;
  assign _6_MUL_value___d24 = 8'd6 * value ;
  assign _7_MUL_value___d21 = 8'd7 * value ;
  assign _9_MUL_value___d14 = 8'd9 * value ;
  ...
  begin
    ...
    init = 1'h0;
    out =
	2592';
    seed = 8'hAA;
    value = 8'hAA;
  end
