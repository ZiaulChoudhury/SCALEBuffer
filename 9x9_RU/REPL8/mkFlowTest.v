...
//
// On Fri Jan 21 16:01:23 GMT 2022
//
//
// Ports:
// Name                         I/O  size props
...
module mkFlowTest(CLK,
  ...
  wire [111 : 0] _15_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_14_M_ETC___d55;
  wire [95 : 0] _15_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_14_M_ETC___d48;
  wire [63 : 0] _15_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_14_M_ETC___d34;
  wire [31 : 0] _15_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_14_M_ETC___d20;
  wire [15 : 0] _10_MUL_value___d24,
		_11_MUL_value___d21,
		_12_MUL_value___d17,
		_13_MUL_value___d14,
		_14_MUL_value___d10,
  ...
  assign px$put_datas =
	     { _15_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_14_M_ETC___d55,
	       value + seed,
	       seed } ;
  ...
  // remaining internal signals
  assign _10_MUL_value___d24 = 8'd10 * value ;
  assign _11_MUL_value___d21 = 8'd11 * value ;
  assign _12_MUL_value___d17 = 8'd12 * value ;
  assign _13_MUL_value___d14 = 8'd13 * value ;
  assign _14_MUL_value___d10 = 8'd14 * value ;
  assign _15_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_14_M_ETC___d20 =
	     { _15_MUL_value___d6[7:0] + seed,
	       _14_MUL_value___d10[7:0] + seed,
	       _13_MUL_value___d14[7:0] + seed,
	       _12_MUL_value___d17[7:0] + seed } ;
  assign _15_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_14_M_ETC___d34 =
	     { _15_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_14_M_ETC___d20,
	       _11_MUL_value___d21[7:0] + seed,
	       _10_MUL_value___d24[7:0] + seed,
	       _9_MUL_value___d28[7:0] + seed,
	       { value[4:0], 3'd0 } + seed } ;
  assign _15_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_14_M_ETC___d48 =
	     { _15_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_14_M_ETC___d34,
	       _7_MUL_value___d35[7:0] + seed,
	       _6_MUL_value___d38[7:0] + seed,
	       _5_MUL_value___d42[7:0] + seed,
	       { value[5:0], 2'd0 } + seed } ;
  assign _15_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_14_M_ETC___d55 =
	     { _15_MUL_value_BITS_7_TO_0_PLUS_seed_CONCAT_14_M_ETC___d48,
	       _3_MUL_value___d49[7:0] + seed,
	       { value[6:0], 1'd0 } + seed } ;
  assign _15_MUL_value___d6 = 8'd15 * value ;
  assign _3_MUL_value___d49 = 8'd3 * value ;
  assign _5_MUL_value___d42 = 8'd5 * value ;
  assign _6_MUL_value___d38 = 8'd6 * value ;
  assign _7_MUL_value___d35 = 8'd7 * value ;
  assign _9_MUL_value___d28 = 8'd9 * value ;
  ...
  begin
    ...
    init = 1'h0;
    out =
	5184';
    seed = 8'hAA;
    value = 8'hAA;
  end
