...
//
// On Fri Jan 21 16:00:07 GMT 2022
//
//
// Ports:
// Name                         I/O  size props
...
module mkFlowTest(CLK,
  ...
  // rule RL__getFinal
  assign WILL_FIRE_RL__getFinal = cx_1$RDY_result && outQ$FULL_N ;
  ...
  assign cx_1$EN_result = WILL_FIRE_RL__getFinal ;

  // submodule outQ
  assign outQ$D_IN = cx_1$result ;
  ...
  begin
    ...
    init = 1'h0;
    out =
	1296';
    seed = 8'hAA;
    value = 8'hAA;
  end
