...
module mkFlowTest(CLK,
  ...
  wire [55 : 0] value_BITS_4_TO_0_CONCAT_0_PLUS_seed_CONCAT_7__ETC___d30;
  wire [39 : 0] value_BITS_4_TO_0_CONCAT_0_PLUS_seed_CONCAT_7__ETC___d23;
  wire [23 : 0] value_BITS_4_TO_0_CONCAT_0_PLUS_seed_CONCAT_7__ETC___d16;
  wire [15 : 0] _3_MUL_value___d24,
		_5_MUL_value___d17,
		_6_MUL_value___d13,
		_7_MUL_value___d10;
  ...
  assign px$put_datas =
	     { value_BITS_4_TO_0_CONCAT_0_PLUS_seed_CONCAT_7__ETC___d30,
	       value + seed,
	       seed } ;
  ...
  // remaining internal signals
  assign _3_MUL_value___d24 = 8'd3 * value ;
  assign _5_MUL_value___d17 = 8'd5 * value ;
  assign _6_MUL_value___d13 = 8'd6 * value ;
  assign _7_MUL_value___d10 = 8'd7 * value ;
  assign value_BITS_4_TO_0_CONCAT_0_PLUS_seed_CONCAT_7__ETC___d16 =
	     { { value[4:0], 3'd0 } + seed,
	       _7_MUL_value___d10[7:0] + seed,
	       _6_MUL_value___d13[7:0] + seed } ;
  assign value_BITS_4_TO_0_CONCAT_0_PLUS_seed_CONCAT_7__ETC___d23 =
	     { value_BITS_4_TO_0_CONCAT_0_PLUS_seed_CONCAT_7__ETC___d16,
	       _5_MUL_value___d17[7:0] + seed,
	       { value[5:0], 2'd0 } + seed } ;
  assign value_BITS_4_TO_0_CONCAT_0_PLUS_seed_CONCAT_7__ETC___d30 =
	     { value_BITS_4_TO_0_CONCAT_0_PLUS_seed_CONCAT_7__ETC___d23,
	       _3_MUL_value___d24[7:0] + seed,
	       { value[6:0], 1'd0 } + seed } ;
